...
from models.schemas import GenerateRequest, GenerateResponse, GARCHParameters, ValidationMetrics
...
def generate_garch_background(job_id: str, historical_data, request: GenerateRequest):
    ...
    try:
        ...
        params = garch.fit_model(historical_data, p=request.p, q=request.q, dist='skewt')
